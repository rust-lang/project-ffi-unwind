...
| Forced unwind, no destructors                           | unwind                        | unwind                       | unwind                               | unwind                                                    | abort                                             | unwind                  | unwind                  |
| Foreign exception, non-forced, no destructors           | UB (debug: abort)             | UB                           | unwind                               | abort                                                     | abort                                             | unwind                  | UB (debug: abort)       |
| Foreign exception (forced or unforced) with destructors | UB (debug: abort)             | UB                           | unwind                               | UB if forced; abort otherwise                             | abort                                             | unwind                  | UB (debug: abort)       |
