...
|                                                         | Proposals 1 & 2, `"C"` boundary, `panic=unwind` | Proposals 1 & 2, `"C"` boundary, `panic=abort` | Proposals 1 & 2, `"C unwind"` boundary, `panic=unwind` | Proposal 1, `"C unwind"` boundary, `panic=abort`  | Proposal 2, `"C unwind"` boundary, `panic=abort`          | Proposal 3,  `"C"` boundary, `panic=unwind` | Proposal 3, `"C"` boundary, `panic=abort` |
| ------------------------------------------------------- | -----------------------------                   | ----------------------------                   | ------------------------------------                   | ------------------------------------------------- | --------------------------------------------------------- | -----------------------                     | -----------------------                   |
| `panic`-unwind                                          | abort                                           | `panic!` aborts (no unwinding occurs)          | unwind                                                 | `panic!` aborts                                   | `panic!` aborts                                           | unwind                                      | `panic!` aborts                           |
| Forced unwind, no destructors                           | unwind                                          | unwind                                         | unwind                                                 | abort                                             | unwind                                                    | unwind                                      | unwind                                    |
| Foreign unwind with destructors                         | UB                                              | UB                                             | unwind                                                 | abort                                             | UB if forced; abort otherwise                             | unwind                                      | UB (debug: abort)                         |
| Foreign unwind, non-forced, no destructors              | abort                                           | unwind                                         | unwind                                                 | abort                                             | abort                                                     | unwind                                      | UB (debug: abort)                         |
| Foreign unwind, non-forced, with destructors            | abort                                           | UB                                             | unwind                                                 | abort                                             | UB if forced; abort otherwise                             | unwind                                      | UB (debug: abort)                         |
