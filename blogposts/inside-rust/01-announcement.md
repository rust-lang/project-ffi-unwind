...
| Foreign exception, non-forced, no destructors           | unwind                                          | unwind                                         | unwind                                                 | abort                                             | abort                                                     | unwind                                      | UB (debug: abort)                         |
| Foreign exception (forced or unforced) with destructors | UB (debug: abort)                               | UB                                             | unwind                                                 | abort                                             | UB if forced; abort otherwise                             | unwind                                      | UB (debug: abort)                         |
